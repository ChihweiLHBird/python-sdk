...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/python-sdk/releases/tag/v0.5.1">
    <img alt="Latest version" src="https://img.shields.io/static/v1?label=release&message=v0.5.1&color=blue&style=for-the-badge" />
  </a>
...
```bash
pip install openfeature-sdk==0.5.1
```
